...
import low_level_scoring_matrix_make_only_index_node
import set_data
import drms
import csv
...
def alignment(aminos, result_array):
    ...
    for i in result_array:
        if i == 'OK':
            ...
            alignment_s.append(amino_a[counter_s])
            counter_s = counter_s + 1
    alignment = [alignment_l, alignment_s]
    return alignment
...
print(amino_a)
print(amino_b)
hight_level_scoring_matrix = low_level_scoring_matrix_make_only_index_node.init(amino_a, amino_b)
